...
public class CRTCLI
{
	public static void main(String[] args)
	{
		...
		{	printUsage();
			...
			//System.out.println("Try 'CRTCLI --help' for more information.");
			System.exit(1);
		}
	...
	{	System.out.println();
		System.out.println("usage:  CRTCLI [options] inputFile [outputFile]");
		System.out.println();
		System.out.println("example:  CRTCLI ecoli.fna");
		System.out.println("example:  CRTCLI -minNR 4 -minRL 21 ecoli.fna a.out");
		System.out.println();
